...
class SalesforcePrototypePipelineStack(Stack):
        ...
        synth_build_spec = {
            ...
            'phases': {
                'build': {
                    'commands': [
                        'printenv',
                        'cd SalesforcePrototype/SalesforcePrototypeCDK',
            ...
            'artifacts': {
                'base-directory': 'SalesforcePrototype/SalesforcePrototypeCDK/cdk.out',
                'files': '**/*'
            }
        }
        # CDK Synth Project
    ...
    def create_dev_docker_build_action(self, source_artifact: aws_codepipeline.Artifact, run_order: int):
        ...
        src_image_name = 'salesforce_prototype-app'
            ...
            'phases': {
                'build': {
                    'commands': [
                        'printenv',
                        'docker version',
                        'cd SalesforcePrototype/SalesforcePrototypeApp',
                        docker_build_cmd,
                        get_pwd_cmd,
