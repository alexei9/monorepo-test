...
class SalesforcePrototypeNotificationProperties:
    """
    Configuration values for creating an instance of the SalesforcePrototypeNotificationConstruct class.
    """

    def __init__(self, base_name: str, subscription_email_address: str):
        """
        Create configuration values for creating an instance of the SalesforcePrototypeNotificationConstruct class.
...
class SalesforcePrototypeNotificationConstruct(Construct):
    """
    A construct that creates an SNS topic and SNS subscription.
    """

    def __init__(self, scope: Construct, construct_id: str, *, properties: SalesforcePrototypeNotificationProperties) -> None:
        """
        ...
        properties : SalesforcePrototypeNotificationProperties
