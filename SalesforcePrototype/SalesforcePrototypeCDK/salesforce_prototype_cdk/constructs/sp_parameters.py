...
class SalesforcePrototypeParametersProperties:
    """
    Configuration values for creating an instance of the SalesforcePrototypeParametersConstruct class.
    """
    ...
    def __init__(self, base_name: str,
        ...
        """
        Create configuration values for creating an instance of the SalesforcePrototypeParametersConstruct class.
...
class SalesforcePrototypeParametersConstruct(Construct):
    """
    A construct that creates a set of Systems Manager Parameter Store parameters.
    """

    def __init__(self, scope: Construct, construct_id: str, *, properties: SalesforcePrototypeParametersProperties) -> None:
        """
        ...
        properties : SalesforcePrototypeParametersProperties
