...
from salesforce_prototype_cdk.utilities.docker_lifecycle_rules \
    import DockerImageLifecycleRules, create_repo_lifecycle_rules


class SalesforcePrototypeEcrRepoProperties:
    """
    Configuration values for creating an instance of the SalesforcePrototypeEcrRepoConstruct class.
    """
    ...
    def __init__(self, create_repo: bool, create_base_name: str,
        ...
        """
        Create configuration values for creating an instance of the SalesforcePrototypeEcrRepoConstruct class.
...
class SalesforcePrototypeEcrRepoConstruct(Construct):
    """
    A construct that creates a new ECR repository or links to an existing ECR repository.
    """

    def __init__(self, scope: Construct, construct_id: str, *, properties: SalesforcePrototypeEcrRepoProperties) -> None:
        """
        ...
        properties : SalesforcePrototypeEcrRepoProperties
