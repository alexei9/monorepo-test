...
class SalesforcePrototypeSnowflakeRoleProperties:
    """
    Configuration values for creating an instance of the SalesforcePrototypeSnowflakeRoleConstruct class.
    """

    def __init__(self, snowflake_principal_arn: str, snowflake_principal_external_id: str, bucket: aws_s3.Bucket):
        """
        Create configuration values for creating an instance of the SalesforcePrototypeSnowflakeRoleConstruct class.
...
class SalesforcePrototypeSnowflakeRoleConstruct(Construct):
    """
    A construct that creates a new IAM role and grants Snowflake permission to assume that role to access S3 buckets.
    """

    def __init__(self, scope: Construct, construct_id: str, *, properties: SalesforcePrototypeSnowflakeRoleProperties) -> None:
        """
        ...
        properties : SalesforcePrototypeSnowflakeRoleProperties
