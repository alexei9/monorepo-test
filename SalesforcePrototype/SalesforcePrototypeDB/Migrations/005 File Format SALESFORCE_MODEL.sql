...
BEGIN
    ...
    GRANT OWNERSHIP ON FILE FORMAT SALESFORCE_LOAD.BASIC_CSV TO ROLE {ADMIN_ROLE_NAME};

    GRANT USAGE ON FILE FORMAT SALESFORCE_LOAD.BASIC_CSV TO ROLE {ADMIN_ROLE_NAME};
END;
