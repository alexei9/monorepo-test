...
BEGIN
    ...
    CREATE STAGE BEIS_LOAD.S3_STAGE
        STORAGE_INTEGRATION = {STORAGE_INTEGRATION_NAME} URL = 's3://cruk-bi-{env}-{solution-name}/';

    GRANT OWNERSHIP ON STAGE BEIS_LOAD.S3_STAGE TO ROLE {ADMIN_ROLE_NAME};

    GRANT USAGE ON STAGE BEIS_LOAD.S3_STAGE TO ROLE {ADMIN_ROLE_NAME};
END;